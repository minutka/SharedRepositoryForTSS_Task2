...
public class ShapeFactory
{
    ...
    public ShapeFactory(final int shape_type) {
        ...
        switch (shape_type / 10) {
            case 1: {
                this.shape = new Star().createStar(3, new Point(0, 0), this.width / 2.0, this.width / 2.0);
                break;
            }
            case 3: {
                this.shape = new Star().createStar(5, new Point(0, 0), this.width / 2.0, this.width / 4.0);
                break;
            }
            case 5: {
